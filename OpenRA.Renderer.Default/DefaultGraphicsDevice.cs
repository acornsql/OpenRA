...
[assembly: Renderer(typeof(OpenRA.Renderer.Default.DeviceFactory))]

namespace OpenRA.Renderer.Default
{
	public class DeviceFactory : IDeviceFactory
	{
		public IGraphicsDevice Create(Size size, WindowMode windowMode)
		{
			Console.WriteLine("Using default renderer");
			return new DefaultGraphicsDevice(size, windowMode);
		}
	}

	public sealed class DefaultGraphicsDevice : IGraphicsDevice
	{
		Size size;
		GameWindow window;
		bool disposed;
		...
		public DefaultGraphicsDevice(Size windowSize, WindowMode windowMode)
		{
			size = windowSize;
			...
			window = new GameWindow(size.Width, size.Height, new GraphicsMode(), "OpenRA");
