...
SendMigs = function(waypoints)
	...
	local mig = Reinforcements.Reinforce(soviets, { "mig" }, migEntryPath, 4)[1]
...
WorldLoaded = function()
	...
	Trigger.AfterDelay(Utils.Seconds(20), function() SendMigs(Mig1Waypoints) end)
	Trigger.AfterDelay(Utils.Seconds(20), function() SendMigs(Mig2Waypoints) end)
