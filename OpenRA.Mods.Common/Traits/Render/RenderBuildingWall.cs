...
namespace OpenRA.Mods.Common.Traits
{
	class RenderBuildingWallInfo : RenderBuildingInfo
	{
		...
		public override IEnumerable<IActorPreview> RenderPreviewSprites(ActorPreviewInitializer init, RenderSpritesInfo rs, string image, int facings, PaletteReference p)
		{
			...
			anim.PlayFetchIndex(DefaultSequence, () => 0);
	...
	class RenderBuildingWall : RenderBuilding, INotifyAddedToWorld, INotifyRemovedFromWorld
	{
		...
		{
			DefaultAnimation.PlayFetchIndex(info.DefaultSequence, () => adjacent);
			UpdateNeighbours(self);
		}

		public override void DamageStateChanged(Actor self, AttackInfo e)
		{
			DefaultAnimation.PlayFetchIndex(NormalizeSequence(DefaultAnimation, e.DamageState, info.DefaultSequence), () => adjacent);
		}
