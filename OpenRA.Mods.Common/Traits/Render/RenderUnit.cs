...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class RenderUnit : RenderSimple
	{
		...
		{
			DefaultAnimation.PlayThen(newAnim, () => { DefaultAnimation.Play(info.DefaultSequence); if (after != null) after(); });
		}
		...
		public void PlayCustomAnimBackwards(Actor self, string name, Action after)
		{
			DefaultAnimation.PlayBackwardsThen(name,
				() => { DefaultAnimation.PlayRepeating(info.DefaultSequence); if (after != null) after(); });
		}
	}
}
